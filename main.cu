...
int main(int argc, char* argv[])
{
	...
	if (flag == 1) {
		read_data(&t, rho_gpu, charge_gpu, phi_gpu, ux_gpu, uy_gpu, Ex_gpu, Ey_gpu);
	}
	else {
	...
	save_data_tecplot(fout, t, rho_gpu, charge_gpu, phi_gpu, ux_gpu, uy_gpu, Ex_gpu, Ey_gpu, 1);
	// file for saving
	...
	save_data_tecplot(fout, t, rho_gpu, charge_gpu, phi_gpu, ux_gpu, uy_gpu, Ex_gpu, Ey_gpu, 0);
	fclose(fout);
	// =============================================================================================================
	// save umax
	// =============================================================================================================
	...
	save_data_end(fend, t, rho_gpu, charge_gpu, phi_gpu, ux_gpu, uy_gpu, Ex_gpu, Ey_gpu);
	fclose(fend);
